...
<%
	...
	String replyWriter = (String)session.getAttribute("session_id");
	BoardDao dao = new BoardDao();
	BoardDto dto = new BoardDto();
	dto = dao.getNotice("qna", idx);
			...
			<div class="container">
                ...
                <div class="card gedf-card">
                    <div class="card-body">
                        ...
                        <div class="btn-group">
                            <button type="button" class="btn btn-primary" id="regReplyBtn" onclick="regReply(<%=dto.getIdx()%>,'<%=replyWriter%>');">답변 등록</button>
                        </div>
                        </div>
                    </div>
                </div>
