		...
		<script type="text/javascript">
			...
			function getReplyList() {
				...
				$.ajax({
					...
					/* obj = {"questList": ["questId":1, "questTitle":2],
										["questId":1, "questTitle":2],
						  } */
			...
			<div class="container">
                ...
                <div class="card gedf-card">
                    <div class="card-body">
                        ...
                        <div class="btn-group">
                            <button type="button" class="btn btn-primary" id="regReplyBtn" onclick="regReply(<%=dto.getIdx()%>,'<%=dto.getWriterId()%>');">답변 등록</button>
                        </div>
                        </div>
                    </div>
                </div>
