...
<%
	...
	String sendpage = null;

	try {
		Properties properties = System.getProperties();
		properties.put("mail.smtp.starttls.enable", "false"); // gmail은 무조건 true 고정
		...
		result_msg = "메일이 정상적으로 전송되었습니다.";
		sendpage = "list.jsp";
		//out.println("<h3>메일이 정상적으로 전송되었습니다.</h3>");
		//response.sendRedirect("list.jsp");
	} catch (Exception e) {
		result_msg = "SMTP 서버가 잘못 설정되었거나, 서비스에 문제가 있습니다.";
		sendpage = "sendEmail.jsp";
